...
$ScriptUrl = 'http://staff.science.uva.nl/~maloni/IaB';
$PubDirUrl = 'http://staff.science.uva.nl/~maloni/pmwiki/pub';
...
## Administrator password (for admin tasks such as making groups, giving people login and edit permission, and so on)
$DefaultPasswords['admin'] = crypt('1nd3f1n1t3s');
## Editors password (allows editing pages)
$DefaultPasswords['edit'] = crypt('1nd3f1n1t3s');
...
$EnableUpload = 1;                       
$DefaultPasswords['upload'] = crypt('1nd3f1n1t3s');
